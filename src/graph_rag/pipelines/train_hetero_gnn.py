...
from graph_rag.gnn.hetero.extraction import (
    connect_to_neo4j, build_heterogeneous_data
)
from graph_rag.gnn.hetero.preparation import (
    prepare_heterogeneous_training_data
)
from graph_rag.gnn.hetero.encoder import (
    build_hetero_model
)
from graph_rag.gnn.hetero.training import (
    train_hetero_model, save_hetero_model, save_hetero_training_artifacts
)
from graph_rag.utils import set_seed
from graph_rag.config import ConfigPath, ConfigEnv
...
def main():
    ...
    try:
        ...
        from graph_rag.gnn.hetero.training import evaluate_hetero_model
